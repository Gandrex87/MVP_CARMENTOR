...
from graph.perfil.nodes import (preguntar_cp_inicial_node,   recopilar_cp_node, validar_cp_node, buscar_info_clima_node,
    ...
    validar_economia_node, preguntar_preferencias_node, preguntar_economia_node,buscar_coches_finales_node, generar_mensaje_transicion_pasajeros,
...
from graph.perfil.condition import (ruta_decision_cp, ruta_decision_economia, decidir_siguiente_paso_perfil, decidir_siguiente_paso_pasajeros, 
