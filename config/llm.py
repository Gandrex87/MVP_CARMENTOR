...
from graph.perfil.state import ResultadoSoloPerfil, ResultadoSoloFiltros, ResultadoEconomia, ResultadoPasajeros, ResultadoCP , InfoPasajeros# Ajusta la ruta de importación
