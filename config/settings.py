...
BONUS_OCASION_POR_IMPACTO_AMBIENTAL = 0.10 # Adicional si es de ocasión
...
# Valores de Pesos basados en altura_mayor_190
PESO_CRUDO_BASE_BATALLA_ALTURA_MAYOR_190 = 1.0
PESO_CRUDO_FAV_BATALLA_ALTURA_MAYOR_190 = 5.0
PESO_CRUDO_FAV_IND_ALTURA_INT_ALTURA_MAYOR_190 = 4.0
...
PESO_CRUDO_FAV_DEVALUACION = 5.0

# Valores pesos de carga y espacio
PESO_CRUDO_BASE_MALETERO= 1.0
PESO_CRUDO_FAV_MALETERO = 5.0
...
RAW_WEIGHT_ADICIONAL_FAV_BAJO_PESO_POR_IMPACTO = 5.0
...
PESO_CRUDO_FAV_MENOR_SUPERFICIE = 7.0 # fav_menor_superficie_planta
PESO_CRUDO_FAV_MENOR_DIAMETRO_GIRO = 7.0 #fav_menor_diametro_giro
PESO_CRUDO_FAV_MENOR_DIMENSION_GARAJE = 6.0 # Para largo, ancho, alto problemáticos
...
RAW_PESO_DEPORTIVIDAD_ALTO = 6.0
RAW_PESO_MENOR_REL_PESO_POTENCIA_ALTO = 7.0
RAW_PESO_POTENCIA_MAXIMA_ALTO = 5.0
RAW_PESO_PAR_MOTOR_DEPORTIVO_ALTO = 5.0
RAW_PESO_MENOR_ACELERACION_ALTO = 6.0
# Si estilo es MIXTO
RAW_PESO_DEPORTIVIDAD_MEDIO = 3.0
RAW_PESO_MENOR_REL_PESO_POTENCIA_MEDIO = 3.5
RAW_PESO_POTENCIA_MAXIMA_MEDIO = 3.5
RAW_PESO_PAR_MOTOR_DEPORTIVO_MEDIO = 2.5
RAW_PESO_MENOR_ACELERACION_MEDIO = 3.0
# Si estilo es TRANQUILO o no definido (base)
RAW_PESO_DEPORTIVIDAD_BAJO = 1.0
RAW_PESO_MENOR_REL_PESO_POTENCIA_BAJO = 0.5
RAW_PESO_POTENCIA_MAXIMA_BAJO = 0.5
RAW_PESO_PAR_MOTOR_DEPORTIVO_BAJO = 0.5
RAW_PESO_MENOR_ACELERACION_BAJO = 1.0

# Pesos crudos para arrastre de remolque si es 'sí'
